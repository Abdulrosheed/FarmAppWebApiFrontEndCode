...
function createTdElement(item,sn)
{
    ...
    button2.addEventListener('click' , function(e)
    {
        ...
        window.location.href = `/Html/adminDetails.html?id=${e.target.id}`
...
{
    fetch("https://localhost:5001/api/Admin/GetAllAdmin")
...
function DeleteIteminDb(id)
{
    ...
    fetch("https://localhost:5001/api/Admin/DeleteAdmin/" + id, {
        method : "DELETE"
    })
    .then(function(value)
    {
