...
function createTdElement(item , sn)
{
    ...
    button2.addEventListener('click' , function(e)
    {
        ...
        window.location.href = `/Html/farmInspectorDetails.html?id=${e.target.id}`
...
{
    fetch("https://localhost:5001/api/FarmInspector/GetAllFarmInspectors")
...
function DeleteIteminDb(id)
{
    ...
    fetch("https://localhost:5001/api/FarmInspector/DeleteFarmInspector/" + id, {
        method : "DELETE"
    })
    .then(function(value)
    {
