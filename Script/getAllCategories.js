...
function createTdElement(item)
{
    ...
    //     window.location.href = `/Html/CategoryDetails.html?id=${e.target.id}`
    ...
    button3.addEventListener('click' , function(e)
    {
        ...
        window.location.href = `/Html/UpdateCategory.html?id=${e.target.id}`
...
function DeleteIteminDb(id)
{
    ...
    fetch("https://localhost:5001/api/Category/DeleteCategory/" + id, {
        method : "DELETE"
    })
    .then(function(value)
    {
