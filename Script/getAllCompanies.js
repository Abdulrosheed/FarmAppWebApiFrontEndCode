...
function createTdElement(item , sn)
{
    ...
    button2.addEventListener('click' , function(e)
    {
        ...
        window.location.href = `/Html/companyDetails.html?id=${e.target.id}`
...
{
    fetch("https://localhost:5001/api/Company/GetAllCompanies")
...
function DeleteIteminDb(id)
{
    ...
    fetch("https://localhost:5001/api/Company/DeleteCompany/" + id, {
        method : "DELETE"
    })
    .then(function(value)
    {
