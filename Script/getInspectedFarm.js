...
function createTdElement(item , sn)
{
    ...
    // button2.innerText = 'Update Report';
    // button2.id = item.id;
    // button2.classList.add('btn-details');
    

    let button = document.createElement('button');
    button.innerText = 'Farm Details';
    button.id = item.id;
    ...
    //     window.location.href = `/Html/updateFarmReport.html?id=${e.target.id}`
...
function getAll()
{
    ...
    fetch("https://localhost:5001/api/FarmInspector/GetInspectedFarm" ,{
        headers : {
