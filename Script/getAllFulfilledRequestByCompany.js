...
function createTdElement(item,sn)
{
    ...
    button2.innerText = 'View Products';
    button2.id = item.id;
    ...
    button2.addEventListener('click' , function(e)
    {
        ...
        window.location.href = `/Html/getProductsforMergedRequest.html?id=${e.target.id}`
...
function getAll()
{
    ...
    fetch("https://localhost:5001/api/Request/GetAllFulfilledRequestByCompany" , {
        headers: {
